...
- اگر تعداد ردیف‌ها از سقف تعیین‌شده بگذرد، خروجی به job پس‌زمینه (ADR-012) سپرده می‌شود و فایل آماده به کاربر اعلام می‌شود.
...
- تعیین سقف تعداد ردیف برای خروجی هم‌زمان گزارش، پیش از سپردن آن به job پس‌زمینه (ADR-014).
